...
import type { MilestoneStanding } from '@/domain/target/milestones';
import { useMilestones } from '@/features/target/useMilestones';
          ...
          if (!data.target || data.standings.length === 0) {
            return (
              <Text variant="body" color="textSecondary">
                Milestones are not yet available for your target.
              </Text>
            );
          }
