...
import { impactPoints, ROAD_STEP_LABELS, roadStepInstruction } from '@/features/target/roadCopy';
          ...
          if (!target || !road) {
            return (
              <Text variant="body" color="textSecondary">
                A road to ready needs a fully modelled target. Yours is not built yet.
              </Text>
            );
          }
              ...
              {road.unmeasuredWeight > 0 ? (
                <Card style={{ gap: theme.spacing.sm }}>
                  <Text variant="headline" color="statusCaution">
                    {`${formatPercent(road.unmeasuredWeight)} of this target is unmeasured`}
                  </Text>
