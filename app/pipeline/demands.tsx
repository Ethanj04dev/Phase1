...
import { DEMAND_LEVEL_LABELS, demandRank, preparationDomain } from '@/domain/pipeline/domains';
    ...
    >
      <AsyncBoundary state={state} onRetry={reload}>
        {({ pipeline }) => {
          if (!pipeline) {
            return (
              <Text variant="body" color="textSecondary">
                Physical demands are not yet available for your pipeline.
              </Text>
            );
          }
          ...
          const ordered = [...pipeline.domains].sort(
          ...
          return (
            <>
              <Text variant="body" color="textSecondary">
                {`What ${pipeline.name} asks of you physically, and why each area matters. This is Zero Phase's assessment of the preparation demands, not an official document.`}
              </Text>
