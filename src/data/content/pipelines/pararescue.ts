import { unverified } from '@/domain/pipeline/provenance';
...
const domains: readonly PipelineDomain[] = [
  {
    id: 'swimming',
    weight: 0.22,
    demand: 'very_high',
...
const preparationBenchmarks: readonly PreparationBenchmark[] = [
  {
    eventId: 'swim_500m',
    target: 570,
    rationale:
...
export const PARARESCUE: PipelineDefinition = {
  id: 'pararescue',
  name: 'Pararescue',
  shortName: 'PJ',
  branch: 'air_force',
